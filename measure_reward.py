...
parser.add_argument("--rm", type=str, default="./models/llama-7b-rm")
parser.add_argument("--rm_gpu", type=str, default="cuda:0")
parser.add_argument("--tokenizer", type=str, default="./models/llama-7b-sft")
...
rm_model = AutoModelForSequenceClassification.from_pretrained(args.rm, num_labels=1, torch_dtype=torch.float16).to(
    args.rm_gpu
)
